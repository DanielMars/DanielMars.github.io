...
> 
> [我的的博客](https://danielmars.github.io/)
>
> 注意：本人是向BY Blog学习的GitHub pages搭建的网页，故留下这篇博文，供后来也想搭建自己博客的人学习。详情可参考[qiubaiying](https://github.com/》>qiubaiying)的博客

# 前言
从 Jekyll 到 GitHub Pages 中间踩了许多坑，终于把我的个人博客[WeiXiao Blog](http://qiubaiying.top)搭建出来了。。。

本教程针对的是想要快速搭建个人博客的感兴趣者，操作简单方便，实现自己的小小博主愿望！
